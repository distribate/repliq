...
import { ShopSelectCurrency } from '@repo/landing-components/src/shop/shop-select-currency.tsx';
...
const ErrorMessage = ({ message }: { message: string | undefined }) => {
  ...
  return <p className="tracking-tight text-sm font-normal text-red">{message}</p>;
};
    ...
    >
      <div className="flex flex-col gap-y-2">
        <div className="flex items-center gap-x-2">
          <Typography text_color="adaptiveWhiteBlack" className="text-[14px] tracking-tight leading-3 lg:text-[16px] break-words">
            Игровой никнейм
          </Typography>
          <img
