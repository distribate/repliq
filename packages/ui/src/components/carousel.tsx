...
const CarouselPrevious = ({ className, variant, size = "icon", ...props }: React.ComponentProps<typeof Button>) => {
...
const CarouselNext = ({ className, variant, size = "icon", ...props }: React.ComponentProps<typeof Button>) => {
