		...
		<Link href="/">
			<div className="flex items-center w-full">
				{isCompact || !isExpanded ? (
					<ImageWrapper priority={true} propSrc={Logotype.src} width={42} height={42} propAlt="Go to Forum"/>
				) : (
					<>
						<ImageWrapper priority={true} propSrc={Logotype.src} width={42} className="h-[42px] w-[56px]" height={42} propAlt="Go to Forum"/>
						<div className="w-fit">
