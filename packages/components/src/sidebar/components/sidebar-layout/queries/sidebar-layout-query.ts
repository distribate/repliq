...
import { SIDEBAR_DEFAULT_SIZE, SIDEBAR_FORMAT_KEY } from '../hooks/use-sidebar-control.ts';
import { useLocalStorage } from "@repo/lib/hooks/use-local-storage.ts";

export const SIDEBAR_LAYOUT_QUERY_KEY: QueryKey = [ "ui", "sidebar-layout-state" ];

export type SidebarFormat = "full"
	| "compact"
	| "dynamic";

export type SidebarQuery = Partial<{
