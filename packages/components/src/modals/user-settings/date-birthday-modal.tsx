...
import {
  DateBirthdayPicker,
} from '#cards/components/user-personal-card/components/profile-settings/components/birthday-picker/components/date-birthday-picker.tsx';
...
export const DateBirthdayModal = () => {
  ...
  return (
    <DynamicModal
      ...
      content={
        <DateBirthdayPicker init={initDate as Date} />
      }
    />
  );
};