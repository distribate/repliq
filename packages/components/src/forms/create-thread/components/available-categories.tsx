...
export const AvailableCategories = ({ enabled }: AvailableCategoriesProps) => {
  const { data: availableCategories, isLoading } =
    availableCategoriesQuery(enabled);

  return (
    <SelectContent
      side="bottom"
      align="center"
      className="max-h-[300px] z-[5] overflow-y-scroll"
    >
