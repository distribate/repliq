...
export const AdditionalSections = () => {
  ...
  return (
    <>
      ...
      {/*  <div className="flex flex-col gap-y-2 w-full rounded-md p-6 border-[1px] border-white/10 bg-shark-950">*/}
      ...
      {/*  </div>*/}
      {/*)}*/}
      <div className="flex flex-col gap-y-2 w-full rounded-md px-6 border-[1px] border-white/10 py-2 bg-shark-950">
        <Accordion type="single" collapsible>
          <AccordionItem value="show-more">
            <AccordionTrigger>
              <Typography textColor="shark_white" textSize="big">Дополнительные настройки</Typography>
            </AccordionTrigger>
            <AccordionContent>
