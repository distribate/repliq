    ...
    <div className="flex flex-col w-full gap-2">
      ...
      {expanded && (
        <div className="flex flex-col gap-1 w-full h-full">
          ...
          <Typography>
            {`>`} заголовок должен быть понятен и не должен быть слишком
            короткий или длинный,
          </Typography>
          <Typography>{`>`} описание треда необязательно</Typography>
          <Typography>
            {`>`} вы можете добавить изображения к треду, если нужно
          </Typography>
          <Typography>
            {`>`} теги могут быть использованы для быстрого поиска треда, но
            необязательны
          </Typography>
        </div>
      )}
