...
import { endOfMonth, endOfYear, format, getMonth, getYear, setYear, startOfMonth, startOfYear } from 'date-fns';
...
export const MonthYearPicker = ({
  ...
  const months = useMemo(() => {
    ...
    for (let i = 0; i < 12; i++) {
      ...
      months.push({ value: i, label: format(new Date(0, i), 'MMM', { locale: ru }), disabled });
    }
