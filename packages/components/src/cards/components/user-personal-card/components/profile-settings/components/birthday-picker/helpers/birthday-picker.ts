...
export function parseDateOrTimestamp(input: string | null | Date): Date | string | null {
  if (!input) {
    return null;
  }
...
export const changeDayWithinRange = (d: Date, date: Date, min: Date, max: Date): Date => {
...
export const generateYears = (value: Date, minDate?: Date, maxDate?: Date): TimeOption[] => {
...
export const generateMonths = (value: Date, minDate?: Date, maxDate?: Date): TimeOption[] => {
