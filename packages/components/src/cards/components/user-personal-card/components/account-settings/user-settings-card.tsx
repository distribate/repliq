    ...
    <div className="flex flex-col gap-y-4 items-center w-full">
      ...
      <div className="flex flex-col gap-y-6 w-full">
        <div className="flex flex-col gap-y-4 w-full">
          <Typography variant="dialogSubtitle" className="px-4">
            Защита
          </Typography>
         <ActiveSessionsModal/>
        ...
        <div className="flex flex-col gap-y-4 w-full">
          <Typography variant="dialogSubtitle" className="px-4">Приватность</Typography>
          <div className="flex flex-col gap-y-2 w-full">
            <HoverCardItem className="justify-between w-full">
              <div className="flex gap-x-2 items-center w-full px-2">
                ...
                />
                <Typography className="text-base">Игровая статистика</Typography>
              </div>
              <div className="w-fit">
                <GameStatsVisibility />
              </div>
            ...
            <HoverCardItem className="justify-between w-full">
              <div className="flex gap-x-2 items-center w-full px-2">
                <ImageWrapper
                  ...
                  propAlt="Change description"
                />
                <Typography className="text-base">Заявки в друзья</Typography>
              </div>
              <div className="w-fit">
                <FriendRequest />
              </div>
            ...
            <HoverCardItem className="justify-between w-full">
              <div className="flex gap-x-2 items-center w-full px-2">
                <ImageWrapper
                  ...
                  propAlt="Change description"
                />
                <Typography className="text-base">Черный список</Typography>
              </div>
              <BlockedListModal/>
            </HoverCardItem>
            <div className="flex flex-col bg-white/10 w-full py-2 px-4">
