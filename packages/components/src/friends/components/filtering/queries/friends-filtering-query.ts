...
export type FriendsFilteringListType =
  | "all"
  | "incoming"
  | "outgoing"
  | "search";
...
export const FRIENDS_FILTERING_QUERY_KEY = createQueryKey("ui", [
  "friends",
  "filtering",
]);
...
export const friendsFilteringQuery = () =>
  useQuery<FriendsFilteringQuery, Error>({
