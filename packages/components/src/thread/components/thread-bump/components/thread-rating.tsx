...
export const ThreadRating = ({ threadId }: ThreadRatingProps) => {
  ...
  return (
    <div className="flex flex-col items-center w-fit gap-1">
      <div className="flex items-center rounded-[8px] bg-shark-900/60 overflow-hidden">
      ...
      <div className="h-[4px] overflow-hidden w-full rounded-[8px]">
        <Progress
          value={percentRating}
          className={
            sumRating > 0 ? "bg-shark-800 *:bg-shark-300" : "bg-shark-800 "
          }
        />
      </div>
    </div>
