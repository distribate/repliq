...
export const CURRENT_THREAD_QUERY_KEY = (threadId: string) =>
  createQueryKey("user", ["thread"], threadId);

export const currentThreadQuery = (threadId: Pick<ThreadModel, "id">["id"]) =>
  useQuery({
