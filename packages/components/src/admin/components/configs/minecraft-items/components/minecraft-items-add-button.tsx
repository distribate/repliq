...
import {
  MINECRAFT_CREATE_ITEM_MUTATION_KEY,
} from '../../../../../forms/create-minecraft-items/hooks/use-minecraft-items.tsx';
import {
  MinecraftItemCreateForm,
} from '../../../../../forms/create-minecraft-items/components/minecraft-item-create-form.tsx';
...
export const MinecraftItemsAddButton = () => {
  ...
  return (
    <Dialog onOpenChange={setIsShow} open={isShow}>
      ...
      <DialogContent>
        {minecraftItemMutationStatus === 'pending' ? <DialogLoader /> : (
