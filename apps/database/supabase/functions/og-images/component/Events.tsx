...
const STORAGE_URL =
  "https://obuldanrptloktxcffvn.supabase.co/storage/v1/object/public";
  ...
  return (
    ...
    >
      ...
      <div tw="flex flex-row items-center justify-center text-[24px] text-[#B4B4B4]">
        <span
          tw="text-[#3ECF8E] uppercase"
          style={{ fontFamily: "SourceCode" }}
        >
          {eventType}
        </span>
      ...
      <div tw="w-full top-0 flex flex-col justify-between mt-4">
        <div tw="flex flex-col w-full">
          <h1 tw="w-3/4 mt-0 mb-2 text-[60px] tracking-tight leading-[105%]">
            {title}
          </h1>
