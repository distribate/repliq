...
CREATE TABLE IF NOT EXISTS "public"."posts_comments_ref" (
...
ALTER TABLE "public"."posts_comments_ref" OWNER TO "postgres";
...
ALTER SEQUENCE "public"."posts_comments_id_seq" OWNED BY "public"."posts_comments_ref"."id";



ALTER TABLE "public"."posts_comments_ref" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
...
CREATE TABLE IF NOT EXISTS "public"."threads_comments_ref" (
    "id" bigint NOT NULL,
    "thread_id" "uuid" NOT NULL,
...
ALTER TABLE "public"."threads_comments_ref" OWNER TO "postgres";


ALTER TABLE "public"."threads_comments_ref" ALTER COLUMN "comment_id" ADD GENERATED BY DEFAULT AS IDENTITY (
...
ALTER SEQUENCE "public"."threads_comments_id_seq" OWNED BY "public"."threads_comments_ref"."id";



ALTER TABLE "public"."threads_comments_ref" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
...
ALTER TABLE ONLY "public"."posts_comments_ref"
...
ALTER TABLE ONLY "public"."threads_comments_ref"
    ADD CONSTRAINT "threads_comments_ref_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."posts_comments_ref"
    ADD CONSTRAINT "posts_comments_comment_id_fkey" FOREIGN KEY ("comment_id") REFERENCES "public"."posts_comments"("id") ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."threads_comments_ref"
    ADD CONSTRAINT "threads_comments_comment_id_fkey" FOREIGN KEY ("comment_id") REFERENCES "public"."threads_comments"("id");



ALTER TABLE ONLY "public"."threads_comments_ref"
    ADD CONSTRAINT "threads_comments_ref_thread_id_fkey" FOREIGN KEY ("thread_id") REFERENCES "public"."threads"("id") ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE "public"."posts_comments_ref" ENABLE ROW LEVEL SECURITY;
...
ALTER TABLE "public"."threads_comments_ref" ENABLE ROW LEVEL SECURITY;
...
GRANT ALL ON TABLE "public"."posts_comments_ref" TO "anon";
GRANT ALL ON TABLE "public"."posts_comments_ref" TO "authenticated";
GRANT ALL ON TABLE "public"."posts_comments_ref" TO "service_role";
...
GRANT ALL ON TABLE "public"."threads_comments_ref" TO "anon";
GRANT ALL ON TABLE "public"."threads_comments_ref" TO "authenticated";
GRANT ALL ON TABLE "public"."threads_comments_ref" TO "service_role";
