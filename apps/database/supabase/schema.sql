...
ALTER TABLE ONLY "public"."threads_comments_replies"
    ADD CONSTRAINT "threads_comments_replies_initiator_comment_id_fkey" FOREIGN KEY ("initiator_comment_id") REFERENCES "public"."threads_comments"("id") ON UPDATE CASCADE;



ALTER TABLE ONLY "public"."threads_comments_replies"
    ADD CONSTRAINT "threads_comments_replies_recipient_comment_id_fkey" FOREIGN KEY ("recipient_comment_id") REFERENCES "public"."threads_comments"("id") ON UPDATE CASCADE;
