...
ALTER TABLE "public"."friends_requests" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."friends_requests_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE IF NOT EXISTS "public"."users" (
    "acceptrules" boolean DEFAULT true NOT NULL,
    "birthday" "date",
    "cover_image" "text",
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "description" "text",
...
ALTER TABLE ONLY "public"."config_minecraft_items" ALTER COLUMN "id" SET DEFAULT "nextval"('"public"."config_minecraft_items_id_seq"'::"regclass");
...
GRANT ALL ON SEQUENCE "public"."friends_requests_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."friends_requests_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."friends_requests_id_seq" TO "service_role";
