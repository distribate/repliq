...
CREATE OR REPLACE FUNCTION "public"."edge_wrapper"("database" "text", "table_name" "text", "nickname" "text", "uuid" "text") RETURNS "jsonb"
  ...
  api_key TEXT;
  response JSONB;
  edge_function_url TEXT := 'http://host.docker.internal:54341/functions/v1/mysql_wrapper';
  post_data TEXT;
BEGIN
...
CREATE OR REPLACE FUNCTION "public"."handle_block_insert"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
  -- Удаление записей в таблице `users_friends`, где user_1 и user_2 совпадают с initiator и recipient в любом порядке
  DELETE FROM public.users_friends
  WHERE (user_1 = NEW.initiator AND user_2 = NEW.recipient)
     OR (user_1 = NEW.recipient AND user_2 = NEW.initiator);
...
ALTER FUNCTION "public"."handle_block_insert"() OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."prevent_duplicate_threads"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
    IF EXISTS (
        SELECT 1
        FROM public.threads_views
        WHERE user_id = NEW.user_id AND thread_id = NEW.thread_id
    ) THEN
        RAISE EXCEPTION 'Cannot insert: a thread view with this user_id and thread_id already exists.';
    END IF;
    RETURN NEW;
END;
$$;
...
ALTER FUNCTION "public"."prevent_duplicate_threads"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."prevent_symmetric_and_self_block"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
  -- Проверка на одинаковые значения initiator и recipient
  IF NEW.initiator = NEW.recipient THEN
    RAISE EXCEPTION 'initiator and recipient cannot be the same';
  END IF;

  -- Проверка на симметричные записи
  IF EXISTS (
    SELECT 1
    FROM public.users_blocked
    WHERE LEAST(NEW.initiator, NEW.recipient) = LEAST(initiator, recipient)
      AND GREATEST(NEW.initiator, NEW.recipient) = GREATEST(initiator, recipient)
  ) THEN
    RAISE EXCEPTION 'Duplicate block entry detected';
  END IF;
...
ALTER FUNCTION "public"."prevent_symmetric_and_self_block"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."prevent_symmetric_entries"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
  IF EXISTS (
...
ALTER FUNCTION "public"."prevent_symmetric_entries"() OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."set_updated_flag_once"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$BEGIN
  IF NEW.content IS DISTINCT FROM OLD.content AND (OLD.edited IS NULL OR OLD.edited = FALSE) THEN
    NEW.edited := TRUE;
  END IF;
  RETURN NEW;
END;$$;
...
ALTER FUNCTION "public"."set_updated_flag_once"() OWNER TO "postgres";
...
ALTER TABLE "public"."admins" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."admins_id_seq1"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE "public"."config_alerts" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."config_alerts_id_seq1"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE "public"."moderators" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
...
ALTER TABLE "public"."posts_views" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."posts_views_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE OR REPLACE VIEW "public"."posts_with_comments_and_view_counts" AS
SELECT
    NULL::"uuid" AS "id",
    NULL::timestamp with time zone AS "created_at",
    NULL::"text" AS "content",
    NULL::"public"."post_visibility" AS "visibility",
    NULL::boolean AS "isUpdated",
    NULL::boolean AS "isPinned",
    NULL::boolean AS "isComments",
    NULL::"text" AS "user_nickname",
    NULL::bigint AS "comments_count",
    NULL::bigint AS "views_count";


ALTER TABLE "public"."posts_with_comments_and_view_counts" OWNER TO "postgres";
...
ALTER TABLE "public"."profile_views" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."profile_views_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE IF NOT EXISTS "public"."reports" (
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "id" bigint NOT NULL,
    "reason" "public"."report_reason" DEFAULT 'spam'::"public"."report_reason" NOT NULL,
...
CREATE TABLE IF NOT EXISTS "public"."threads_comments_replies" (
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "id" bigint NOT NULL,
...
ALTER TABLE "public"."threads_comments_replies" OWNER TO "postgres";
...
ALTER SEQUENCE "public"."t_comments_replies_id_seq" OWNED BY "public"."threads_comments_replies"."id";



ALTER TABLE "public"."threads_comments_replies" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
...
CREATE TABLE IF NOT EXISTS "public"."threads" (
    ...
    "isImages" boolean DEFAULT false NOT NULL,
    "isUpdated" boolean DEFAULT false NOT NULL,
...
CREATE TABLE IF NOT EXISTS "public"."threads_views" (
    "id" bigint NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "user_id" "uuid",
    "thread_id" "uuid" NOT NULL
...
ALTER TABLE "public"."threads_views" OWNER TO "postgres";


ALTER TABLE "public"."threads_views" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."threads_views_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE "public"."users_banned" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."users_banned_id_seq1"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE "public"."users_blocked" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."users_blocked_id_seq1"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE IF NOT EXISTS "public"."users_saved_threads" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "user_id" "uuid",
    "thread_id" "uuid"
...
ALTER TABLE "public"."users_saved_threads" OWNER TO "postgres";
...
ALTER TABLE ONLY "public"."posts_comments"
    ADD CONSTRAINT "posts_comments_pkey1" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."posts_views"
    ADD CONSTRAINT "posts_views_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."threads_comments_replies"
...
ALTER TABLE ONLY "public"."threads_rating"
    ADD CONSTRAINT "threads_rating_unique_constraint" UNIQUE ("thread_id", "user_id", "type");
...
ALTER TABLE ONLY "public"."threads_views"
    ADD CONSTRAINT "threads_views_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."posts_views"
    ADD CONSTRAINT "unique_post_user_view" UNIQUE ("post_id", "user_id");
...
ALTER TABLE ONLY "public"."users_saved_threads"
    ADD CONSTRAINT "users_saved_threads_pkey" PRIMARY KEY ("id");
...
CREATE UNIQUE INDEX "unique_initiator_recipient_idx" ON "public"."users_blocked" USING "btree" (LEAST("initiator", "recipient"), GREATEST("initiator", "recipient"));
...
CREATE OR REPLACE VIEW "public"."posts_with_comments_and_view_counts" AS
 SELECT "posts"."id",
    ...
    "posts"."isPinned",
    "posts"."isComments",
    "posts_users"."user_nickname",
    "count"("posts_comments"."id") AS "comments_count",
    "count"("posts_views"."id") AS "views_count"
   FROM ((("public"."posts"
     LEFT JOIN "public"."posts_comments" ON (("posts"."id" = "posts_comments"."post_id")))
     LEFT JOIN "public"."posts_views" ON (("posts"."id" = "posts_views"."post_id")))
     LEFT JOIN "public"."posts_users" ON (("posts"."id" = "posts_users"."post_id")))
  GROUP BY "posts"."id", "posts_users"."user_nickname";
...
CREATE OR REPLACE TRIGGER "check_symmetric_and_self_block" BEFORE INSERT ON "public"."users_blocked" FOR EACH ROW EXECUTE FUNCTION "public"."prevent_symmetric_and_self_block"();



CREATE OR REPLACE TRIGGER "prevent_duplicate_threads_trigger" BEFORE INSERT ON "public"."threads_views" FOR EACH ROW EXECUTE FUNCTION "public"."prevent_duplicate_threads"();



CREATE OR REPLACE TRIGGER "set_edited_flag_on_content_change" BEFORE UPDATE ON "public"."threads_comments" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_flag_once"();
...
CREATE OR REPLACE TRIGGER "trigger_handle_block_insert" AFTER INSERT ON "public"."users_blocked" FOR EACH ROW EXECUTE FUNCTION "public"."handle_block_insert"();
...
ALTER TABLE ONLY "public"."config_alerts"
    ADD CONSTRAINT "config_alerts_creator_fkey" FOREIGN KEY ("creator") REFERENCES "public"."users"("nickname") ON UPDATE CASCADE;
...
ALTER TABLE ONLY "public"."info_findout"
    ADD CONSTRAINT "info_findout_user_nickname_fkey" FOREIGN KEY ("user_nickname") REFERENCES "public"."users"("nickname") ON UPDATE CASCADE ON DELETE CASCADE;



ALTER TABLE ONLY "public"."moderators"
    ADD CONSTRAINT "moderators_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."posts_comments"
    ADD CONSTRAINT "posts_comments_post_id_fkey" FOREIGN KEY ("post_id") REFERENCES "public"."posts"("id") ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."posts_views"
    ADD CONSTRAINT "posts_views_post_id_fkey" FOREIGN KEY ("post_id") REFERENCES "public"."posts"("id") ON UPDATE CASCADE ON DELETE CASCADE;



ALTER TABLE ONLY "public"."posts_views"
    ADD CONSTRAINT "posts_views_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON UPDATE CASCADE ON DELETE CASCADE;



ALTER TABLE ONLY "public"."profile_views"
    ADD CONSTRAINT "profile_views_target_user_id_fkey" FOREIGN KEY ("target_user_id") REFERENCES "public"."users"("id") ON UPDATE CASCADE ON DELETE CASCADE;



ALTER TABLE ONLY "public"."profile_views"
    ADD CONSTRAINT "profile_views_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."threads_comments_replies"
    ADD CONSTRAINT "threads_comments_replies_initiator_comment_id_fkey" FOREIGN KEY ("initiator_comment_id") REFERENCES "public"."threads_comments"("id") ON UPDATE CASCADE ON DELETE CASCADE;



ALTER TABLE ONLY "public"."threads_comments_replies"
    ADD CONSTRAINT "threads_comments_replies_recipient_comment_id_fkey" FOREIGN KEY ("recipient_comment_id") REFERENCES "public"."threads_comments"("id") ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."threads_comments"
    ADD CONSTRAINT "threads_comments_user_nickname_fkey" FOREIGN KEY ("user_nickname") REFERENCES "public"."users"("nickname") ON UPDATE CASCADE;
...
ALTER TABLE ONLY "public"."threads_views"
    ADD CONSTRAINT "threads_views_thread_id_fkey" FOREIGN KEY ("thread_id") REFERENCES "public"."threads"("id") ON UPDATE CASCADE ON DELETE CASCADE;



ALTER TABLE ONLY "public"."threads_views"
    ADD CONSTRAINT "threads_views_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON UPDATE CASCADE;
...
ALTER TABLE ONLY "public"."users_blocked"
    ADD CONSTRAINT "users_blocked_initiator_fkey" FOREIGN KEY ("initiator") REFERENCES "public"."users"("nickname") ON UPDATE CASCADE ON DELETE CASCADE;



ALTER TABLE ONLY "public"."users_blocked"
    ADD CONSTRAINT "users_blocked_recipient_fkey" FOREIGN KEY ("recipient") REFERENCES "public"."users"("nickname") ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."users_saved_threads"
    ADD CONSTRAINT "users_saved_threads_thread_id_fkey" FOREIGN KEY ("thread_id") REFERENCES "public"."threads"("id") ON UPDATE CASCADE ON DELETE CASCADE;



ALTER TABLE ONLY "public"."users_saved_threads"
    ADD CONSTRAINT "users_saved_threads_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE "public"."category_threads" ENABLE ROW LEVEL SECURITY;


ALTER TABLE "public"."config_advertisement" ENABLE ROW LEVEL SECURITY;


ALTER TABLE "public"."config_alerts" ENABLE ROW LEVEL SECURITY;


ALTER TABLE "public"."config_minecraft_facts" ENABLE ROW LEVEL SECURITY;


ALTER TABLE "public"."config_minecraft_items" ENABLE ROW LEVEL SECURITY;
...
ALTER TABLE "public"."info_findout" ENABLE ROW LEVEL SECURITY;
...
ALTER TABLE "public"."posts_views" ENABLE ROW LEVEL SECURITY;
...
ALTER TABLE "public"."threads_comments_replies" ENABLE ROW LEVEL SECURITY;


ALTER TABLE "public"."threads_images" ENABLE ROW LEVEL SECURITY;


ALTER TABLE "public"."threads_pinned" ENABLE ROW LEVEL SECURITY;


ALTER TABLE "public"."threads_rating" ENABLE ROW LEVEL SECURITY;


ALTER TABLE "public"."threads_stars" ENABLE ROW LEVEL SECURITY;


ALTER TABLE "public"."threads_tags" ENABLE ROW LEVEL SECURITY;


ALTER TABLE "public"."threads_users" ENABLE ROW LEVEL SECURITY;


ALTER TABLE "public"."threads_views" ENABLE ROW LEVEL SECURITY;
...
ALTER TABLE "public"."users_friends" ENABLE ROW LEVEL SECURITY;


ALTER TABLE "public"."users_requests_timeout" ENABLE ROW LEVEL SECURITY;


ALTER TABLE "public"."users_saved_threads" ENABLE ROW LEVEL SECURITY;
...
GRANT ALL ON FUNCTION "public"."handle_block_insert"() TO "anon";
GRANT ALL ON FUNCTION "public"."handle_block_insert"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."handle_block_insert"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."prevent_duplicate_threads"() TO "anon";
GRANT ALL ON FUNCTION "public"."prevent_duplicate_threads"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."prevent_duplicate_threads"() TO "service_role";



GRANT ALL ON FUNCTION "public"."prevent_symmetric_and_self_block"() TO "anon";
GRANT ALL ON FUNCTION "public"."prevent_symmetric_and_self_block"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."prevent_symmetric_and_self_block"() TO "service_role";



GRANT ALL ON FUNCTION "public"."prevent_symmetric_entries"() TO "anon";
GRANT ALL ON FUNCTION "public"."prevent_symmetric_entries"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."prevent_symmetric_entries"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."set_updated_flag_once"() TO "anon";
GRANT ALL ON FUNCTION "public"."set_updated_flag_once"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."set_updated_flag_once"() TO "service_role";
...
GRANT ALL ON SEQUENCE "public"."admins_id_seq1" TO "anon";
GRANT ALL ON SEQUENCE "public"."admins_id_seq1" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."admins_id_seq1" TO "service_role";
...
GRANT ALL ON SEQUENCE "public"."config_alerts_id_seq1" TO "anon";
GRANT ALL ON SEQUENCE "public"."config_alerts_id_seq1" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."config_alerts_id_seq1" TO "service_role";
...
GRANT ALL ON SEQUENCE "public"."moderators_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."moderators_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."moderators_id_seq" TO "service_role";
...
GRANT ALL ON SEQUENCE "public"."posts_views_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."posts_views_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."posts_views_id_seq" TO "service_role";



GRANT ALL ON TABLE "public"."posts_with_comments_and_view_counts" TO "anon";
GRANT ALL ON TABLE "public"."posts_with_comments_and_view_counts" TO "authenticated";
GRANT ALL ON TABLE "public"."posts_with_comments_and_view_counts" TO "service_role";
...
GRANT ALL ON TABLE "public"."threads_comments_replies" TO "anon";
GRANT ALL ON TABLE "public"."threads_comments_replies" TO "authenticated";
GRANT ALL ON TABLE "public"."threads_comments_replies" TO "service_role";
...
GRANT ALL ON TABLE "public"."threads_views" TO "anon";
GRANT ALL ON TABLE "public"."threads_views" TO "authenticated";
GRANT ALL ON TABLE "public"."threads_views" TO "service_role";



GRANT ALL ON SEQUENCE "public"."threads_views_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."threads_views_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."threads_views_id_seq" TO "service_role";
...
GRANT ALL ON SEQUENCE "public"."users_banned_id_seq1" TO "anon";
GRANT ALL ON SEQUENCE "public"."users_banned_id_seq1" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."users_banned_id_seq1" TO "service_role";
...
GRANT ALL ON SEQUENCE "public"."users_blocked_id_seq1" TO "anon";
GRANT ALL ON SEQUENCE "public"."users_blocked_id_seq1" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."users_blocked_id_seq1" TO "service_role";
...
GRANT ALL ON TABLE "public"."users_saved_threads" TO "anon";
GRANT ALL ON TABLE "public"."users_saved_threads" TO "authenticated";
GRANT ALL ON TABLE "public"."users_saved_threads" TO "service_role";
