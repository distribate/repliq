      ...
      <div className="flex flex-col gap-4 w-full p-2">
        ...
        <div className="flex flex-col gap-4 w-full">
          {ctx.spy(deleteAccountIsAcceptedAtom) ? (
            <>
              ...
              <div className="flex gap-2">
                <Button
                  ...
                  disabled={ctx.spy(deleteAccountAction.statusesAtom).isPending}
                >
                ...
                <Button
                  state="default"
                  onClick={() => deleteAccountIsAcceptedAtom(ctx, false)}
                >
                  <Typography textSize="medium">
                    Отмена
                  </Typography>
            ...
            <Button
              onClick={() => deleteAccountIsAcceptedAtom(ctx, true)}
              className="bg-shark-50 self-end"
            >
