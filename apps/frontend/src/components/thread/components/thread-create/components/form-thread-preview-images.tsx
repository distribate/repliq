import { bgColorAtom, addImagesAction, deleteImageAction, threadFormImagesAtom } from "../models/thread-form.model.ts";
...
const ThreadFormImageItem = reatomComponent<{ image: string, idx: number }>(({ ctx, image, idx }) => {
  return (
    <Dialog>
      ...
      >
        <DeleteButton onClick={e => deleteImageAction(ctx, e, idx)} variant="invisible" />
        <img
