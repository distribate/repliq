...
export const CreateIssueForm = reatomComponent(({ ctx }) => {
  ...
  return (
    <div className="flex flex-col gap-y-6 w-full">
      <div className="flex bg-primary-color rounded-lg xl:flex-row xl:justify-between flex-col gap-6 items-start p-0 w-full">
        <form
          onSubmit={onSubmit}
      ...
      <div className="flex bg-primary-color rounded-lg flex-col gap-2 p-4 w-full">
