import { isExistAtom, profileThreadsAction, profileThreadsDataAtom, profileThreadsViewAtom } from '../models/profile-threads.model.ts';
...
const ProfileThreadsListCard = reatomComponent<ThreadCardProps>(({
