...
import { uploadBackgroundImageAction } from "#components/profile/components/head/models/head-image.model.ts";
import { Image } from 'lucide-react';
import { imagesLibraryAction } from '#components/profile/components/head/models/head-image.model.ts';
...
onConnect(imagesLibraryAction.dataAtom, imagesLibraryAction)

const HeadImagesList = reatomComponent(({ ctx }) => {
...
const HeadImageDefaultImagesModal = reatomComponent(({ ctx }) => {
  return (
    <DynamicModal
      autoClose
      withLoader
...
}, "HeadImageDefaultImagesModal")

const HeadImageUploadCustom = reatomComponent(({ ctx }) => {
...
}, "HeadImageUploadCustom")

export const HeadImageUpdateModal = reatomComponent(({ ctx }) => {
  return (
    <DynamicModal
      autoClose
      withLoader
