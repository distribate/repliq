...
import { createReportAction } from "../models/create-report.model.ts";
...
} from "#components/modals/with-confirm/report/models/report.model.ts";
...
export const ReportCreateModal = reatomComponent<ReportItemProps>(({
  ...
  const isDisabled = ctx.spy(createReportAction.statusesAtom).isPending
          ...
          <ConfirmationActionModalTemplate title={ctx.spy(reportDialogTitleAtom)}>
            <div className="flex flex-col gap-y-4 w-full">
              ...
              <div className="flex items-center gap-2 w-full justify-end">
                {stage === "description" && (
                  <Button className="bg-shark-50" onClick={createReport} disabled={isDisabled}>
