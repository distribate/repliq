...
import { logger, natsLogger } from "@repo/shared/utils/logger.ts"
...
import { removeCommentRoute } from '#routes/comments/remove-comment.ts';
import { getAdminsRoute } from '#routes/admin/get-admins.ts';
