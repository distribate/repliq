...
const UserProfileAccountStats = dynamic(() =>
  import(
    "@repo/components/src/profile/components/account-stats/components/profile-account-stats.tsx"
  ).then((m) => m.UserProfileAccountStats),
);

const ProfilePrivated = dynamic(() =>
  import("@repo/components/src/templates/profile-privated.tsx").then(
    (m) => m.ProfilePrivated,
  ),
);
...
const UserProfileGameAchievements = dynamic(() =>
  import(
    "@repo/components/src/profile/components/achievements/components/profile-game-ach.tsx"
  ).then((m) => m.UserProfileGameAchievements),
);

const UserBlocked = dynamic(() =>
  import("@repo/components/src/templates/user-blocked.tsx").then(
    (m) => m.UserBlocked,
  ),
);
...
const UserProfileFriends = dynamic(() =>
  import(
    "@repo/components/src/profile/components/friends/components/profile-friends.tsx"
  ).then((m) => m.UserProfileFriends),
);

const UserProfileThreads = dynamic(() =>
  import(
    "@repo/components/src/profile/components/threads/components/profile-threads.tsx"
  ).then((m) => m.UserProfileThreads),
);

const UserProfileGameStats = dynamic(() =>
  import(
    "@repo/components/src/profile/components/stats/components/profile-stats.tsx"
  ).then((m) => m.UserProfileGameStats),
);

const UserBanned = dynamic(() =>
  import("@repo/components/src/templates/user-banned.tsx").then(
    (m) => m.UserBanned,
  ),
);
...
const UserProfileSkin = dynamic(() =>
  import(
    "@repo/components/src/profile/components/skin/components/profile-skin.tsx"
  ).then((m) => m.UserProfileSkin),
);

const SectionPrivatedTrigger = dynamic(() =>
  import("@repo/components/src/templates/section-privated-trigger.tsx").then(
    (m) => m.SectionPrivatedTrigger,
  ),
);
...
type CheckUserGameStatsVisibility = {
  preferences: Pick<CurrentUser, "preferences">["preferences"];
...
function checkUserGameStatsVisibility({
  ...
  const gameStatsShow = preferences.game_stats_visible
...
const ProfileContentPage = async ({
  ...
  const isSectionPrivatedByOwner =
    !preferences.game_stats_visible &&
...
export default async function ProfilePage({ params }: PageConventionProps) {
  ...
  const isBlocked =
    profileStatus === "blocked-by-user" || profileStatus === "user-blocked";
  ...
  return (
    <div className="flex flex-col w-full relative">
      ...
      {!isPrivated && !profileStatus && (
        <ProfileContentPage requestedUser={requestedUser} currentUser={user} />
      )}
    </div>
  );
}