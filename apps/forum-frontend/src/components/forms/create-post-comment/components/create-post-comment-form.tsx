...
//   PostCommentField,
// } from "#components/forms/create-post-comment/queries/post-comment-field-query.ts";
...
// export const CreatePostCommentForm = reatomComponent<Pick<PostEntity, "id">>(({ id: postId, ctx }) => {
