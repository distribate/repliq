...
import { deleteAccountAction, deleteAccountIsAcceptedAtom, deleteAccountPasswordAtom } from "../models/delete-account.model"
...
export const DeleteAccountModal = reatomComponent(({ ctx }) => {
  const handleDelete = () => {
