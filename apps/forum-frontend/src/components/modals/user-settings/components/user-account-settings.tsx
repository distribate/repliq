...
import { AccountDialog, navigateToDialogAction, settingsCurrentDialogAtom } from '../models/user-settings.model';
...
export const UserAccountSettingsCard = reatomComponent(({ ctx }) => {
