import { createMinecraftItemAction } from "../models/create-minecraft-item.model.tsx";
    ...
    <>
      <div className="flex items-start w-full gap-2 overflow-hidden">
        ...
        {previewImage ? (
          ...
          <div className="flex relative hover-select-effect justify-center items-center w-[128px] h-[128px] rounded-md">
