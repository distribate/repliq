import { FRIENDS_SORT_QUERY_KEY, FriendsSortQuery } from "#components/friends/components/filtering/components/friends-filtering-search.tsx";
import { FRIENDS_QUERY_KEY } from "#components/friends/queries/friends-query.ts";
import { getFriends } from "#components/friends/queries/get-friends.ts";
