...
export const SIDEBAR_LINKS = [
  {
    title: "Мониторинги",
    link: "https://fasberry.su/misc/monitorings",
  },
  {
    title: "Статус",
    link: "https://fasberry.su/misc/status",
  }
]
...
const OutlineWrapper = ({ children, className, ...props }: HTMLAttributes<HTMLDivElement>) => {
  return (
    <div
      className={`flex items-center justify-center bg-shark-800 hover:bg-shark-600 
        py-3 px-4 duration-100 ease-in-out transition cursor-pointer rounded-md ${className}`}
      {...props}
    >
      {children}
    </div>
