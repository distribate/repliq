...
const FriendProfileCard = ({ nickname, name_color, is_donate, description }: FriendWithDetails) => {
  return (
    <div className="flex gap-2 items-center w-full bg-shark-950 py-4 px-4 rounded-lg">
      <CustomLink to={createIdLink("user", nickname)}>
        <Avatar propHeight={64} propWidth={64} nickname={nickname} className="min-w-[64px] min-h-[64px]" />
      </CustomLink>
