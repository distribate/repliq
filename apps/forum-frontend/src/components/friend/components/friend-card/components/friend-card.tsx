...
import { FriendCardLayout } from "#components/friend/components/friend-card/components/friend-card-layout";
import { FriendCardControl } from "#components/friend/components/friend-card-control/components/friend-card-control";
import { FriendCardNote } from "#components/friend/components/friend-card-details/components/friend-card-note";
