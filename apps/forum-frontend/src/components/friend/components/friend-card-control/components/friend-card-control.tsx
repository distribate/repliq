...
import { FriendCardControlPin } from "#components/friend/components/friend-card-control/components/friend-card-control-pin.tsx";
import { FriendWithDetails } from "@repo/types/schemas/friend/friend-types.ts";
import { FriendCardControlNote } from "./friend-card-control-note";
