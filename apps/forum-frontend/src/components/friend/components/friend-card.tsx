...
import { FriendCardControl } from "#components/friend/components/friend-card-control.tsx";
import { FriendCardNote } from "#components/friend/components/friend-card-note.tsx";
