            ...
            {"nickname" in item && (
              <div className="flex group w-full h-full relative">
                <X
                  ...
                  size={24}
                />
                <SearchPageUser description={item.description} avatar={item.avatar} nickname={item.nickname} name_color={item.name_color} />
              </div>
            )}
            {"title" in item && (
              <div className="flex group w-full h-full relative">
                <X
                  ...
                  size={24}
                />
                <SearchPageThread id={item.id} title={item.title} />
              </div>
            )}
          </Fragment>
        ))}
