...
import {
  userBlockedQuery,
} from '#components/cards/user-personal-card/components/account-settings/queries/user-blocked-query.ts';
...
import { PasswordChangeModal } from '#components/modals/user-settings/password-change-modal.tsx';
import { ActiveSessionsModal } from '#components/modals/user-settings/active-sessions-modal.tsx';
