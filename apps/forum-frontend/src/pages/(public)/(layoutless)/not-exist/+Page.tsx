...
export default function NotExistPage() {
  return <NotExistRouteComponent />
}

function NotExistRouteComponent() {
  const redirect_nickname = usePageContext().urlParsed.search.redirect_nickname

  if (!redirect_nickname) return null
