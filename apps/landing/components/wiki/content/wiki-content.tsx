...
import { WikiNavigationBar } from "#/components/wiki/sidebar/wiki-navigation-bar";
...
import { ImageAnnotation } from "#/ui/annotation-item";
import { Tooltip, TooltipContent, TooltipTrigger } from "#/ui/tooltip";
import { WikiTableComponent } from "#/components/wiki/table/wiki-table";
import { ARMORS } from "#/shared/data/wiki/wiki-list";
import {
	armorColumnsArmor,
...
export const WikiContent = () => {
	...
	return (
		...
		>
			<WikiNavigationBar/>
			<Block className="w-full overflow-hidden lg:w-auto rounded-xl" border="mini_gray" type="column" rounded="big"
						 size="normal">
