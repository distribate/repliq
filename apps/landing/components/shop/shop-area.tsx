...
} from '#/components/subs/subscription-item-form.tsx';
...
import { CREATE_PAYMENT_DATA_QUERY_KEY, CREATE_PAYMENT_MUTATION_KEY } from '#/lib/hooks/use-create-payment.ts';
...
export const ShopArea = () => {
  ...
  const paymentData = qc.getQueryData<PaymentResponse | string[]>(CREATE_PAYMENT_DATA_QUERY_KEY);
