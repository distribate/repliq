...
import { HeaderSheet } from "#components/layout/default/header-sheet.tsx";
...
const ThemeToggle = dynamic(
	() =>
		import("#components/layout/default/header-theme-toggle").then(m => ({
...
export const headerUserQuery = () => useQuery({
	...
	queryFn: async () => {
		const userFromCookie = getCookieByKey("user")
